...
| `MBACR-FT02` | T1A tool, independence, fixture, commit, or TO02 publication failure | Historical TO01 unchanged; Failed/absent TO02 only; `2/5,0/1`; no source read/L01 | `CorrectMBACRT1ATO02` |
...
After the in-slot TO02 correction and publication, the sole next action is `AwaitTotalControlAuditBeforeMBACRT1B`.
