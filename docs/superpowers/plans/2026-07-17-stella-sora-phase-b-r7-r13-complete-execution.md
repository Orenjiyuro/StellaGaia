...
- `LO1-IP01` is `Tools/AssetImport/New-CergLo1Preflight.ps1`, `17591` bytes, SHA-256 `ae674bf964077ddadd660bc861f10d6d827729d2aae4e12b3ba120d543744b97`. Corrected TG01 is `Tools/AssetImport/Invoke-CergLo1ExactStaging.ps1`, `ExactLeafStagingWrapper/CERG-LO1-EXACT-STAGING/3`, `19951` bytes, SHA-256 `8fd4c18cb4372bd6a485ab6afd46b1b45d478e670b79d9d61fe52ee025a6aa77`. Focused test `Tools/AssetImport/Test-CergLo1PreflightContract.ps1` is `6162` bytes, SHA-256 `b9dbff4ae974b51bde8a70e4ea4569da4774b11b61e15a033765567ff25c34f1`. Corrected TG03 `Tools/AssetImport/Test-CergLo1Pipeline.ps1` is `69155` bytes, SHA-256 `348e7f1566d47276c6f04cb9023075e7e5e8a82bfa50fe2fe0b094f53410c9c7`. TO04 remains immutable history for its bound bytes and does not approve these changed bytes; total control must audit this recovery commit and all four identities before replacement.
...
- `CR1-FT02/RecoveryReadyForAudit`: synchronized overrides, the four identities above, focused `8/8 Passed`, regression `24/24 Passed`, syntax and `git diff --check` Green, unchanged original/protected hashes, and no replacement/source/producer/Unity output. Counters are `4/7,0/3`; sole next action `AwaitTotalControlAuditBeforeAnyReplacementLO`.
