...
**Current baseline:** `codex/asset-corpus-integration` includes the LC-I07 and LC-I11 physical contract checkpoints. C0 and C1 Phase A are complete. C2 Phase A intake through SP-09 publication is implemented and its complete fixture-only path has passed completion verification. The C2 Phase B fixture-to-real runbook is written, but Phase B remains unauthorized. C3–C6 responsibilities and input/output contracts are defined, and the prerequisite LC-I06/LC-I07/LC-I11 fixture-only contracts are implemented; C3–C6 implementation, G5 integration, Phase B execution, and C7/G4 Unity have not started.
