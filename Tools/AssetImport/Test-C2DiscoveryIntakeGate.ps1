...
if($Case -ceq 'OutputSerialization'){
    ...
    if($passed.discoveryArtifactFingerprint-cne'37a74c739896163a4d9edd65bd075ba299492ea276fa0cacfc9b7920face14b1'-or$passed.diagnosticBundleFingerprint-cne'e6c415257ebe483edbef9fc0f5b7f2139a8ed6e3ab8bedcfe81a2c2c376a6343'){throw "Passed HI-13c/HI-14 literal mismatch: $($passed.discoveryArtifactFingerprint),$($passed.diagnosticBundleFingerprint)"}
    if(($passed.artifacts.sha256-join',')-cne'e2f3cb01cd005a7f046d4cdd61a6df873d3406e0d40f0695792d71d04f9f0441,a26d43c648ac1a11d19ed0ee4d43afcde6266108622eca8745110f2a12054f7f,bcc8c280902dba1a50c172c7476f797f72e54c2c6b5d3a2765c7dc1e192e10e8,ff452203269549f18b8699c568d3d4f6ad9cd9b7e57a497f0fee9a492bf93d54,cee73cd5c191039da5cbdcdfa7bbf832ce5e950a245db3d69c502e11d040185c,f29b5139213b394fd065fdb73a70caf9f1c6d753d15f1d93a116651a9e51a660,4aac7540bdbfbc9e35ad6db461a442b5f3aad200311081db2852dcdad3bbf22d,c929e2f932dd7fd150c0e0323ff9273ffbb9d2c91aa4d9f867704ba88ecc9d65'){throw "Passed CT-15 literal SHA set mismatch: $($passed.artifacts.sha256-join',')"}
    ...
    if($failed.discoveryArtifactFingerprint-cne'6d86f3b458a9cc3b0096765ea8a5a4f01ae5bb0bcb84fa00705b03edaf71bc4d'-or$failed.diagnosticBundleFingerprint-cne'e2f7a676f070f89377f0e69e293c45ebbe9e8c39c6b1649727f998e1cd470c8f'){throw "Failed HI-13c/HI-14 literal mismatch: $($failed.discoveryArtifactFingerprint),$($failed.diagnosticBundleFingerprint)"}
    if(($failed.artifacts.sha256-join',')-cne',,,,36a044640c4f55b3fb9aa4285d523ca812986049d33816b68d0c770a875d08e3,946ee75054fe711a55f15920ff03283730809a5d3b11c2d0db363f6b5b22bbb8,8d75b7de2d8af4cb5663789f7013c099e40b1cde1a732e7270b94947ebeec0e0,a7de7bf8754a106311bfce7ff7026202c0a42873eac725e276473dabdb7906a4'){throw "Failed CT-15 literal SHA set mismatch: $($failed.artifacts.sha256-join',')"}
...
if($Case -ceq 'InputAccounting'){
    ...
    $contractChange=[pscustomobject][ordered]@{schemaVersion='1.0.0';generatedAt='2026-07-15T00:00:00Z';requestId='C0ContractChange:C2StructuredCoverage:1.0.0';reason='Current root-gate-summary schema cannot losslessly represent mandatory C2 structured coverage partitions.';nextAllowedAction='Continue C3-C6 Phase A; C0 must resolve this request before G5 can pass.';inputFingerprint=('a'*64);discoveryInputFingerprint=$boundFingerprint;status='Required';missingProjectionFields=$missingProjectionFields;evidence=@('Tools/AssetImport/Fixtures/DiscoveryGate/valid-discovery-summary.json','docs/asset-migration/schemas/root-gate-summary.schema.json')}
...
if ($Case -in @('Integration','FileFixtureIntake')) {
    ...
    if($independentD9 -cne '96b09428bc1f08b74a85c5b7fb489b4a2fb8242cc3e1a7623b6f855e15dee56b'){throw "Independent D9 mismatch: $independentD9"}
...
$expected = '9fbb174d2ad7dd47ba90f5dac411b96725bf0609234ff9271475ec740c0221e1'
