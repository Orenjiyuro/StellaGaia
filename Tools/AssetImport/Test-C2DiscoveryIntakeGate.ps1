[CmdletBinding()]
param(
    [ValidateSet('Pure','GitAdapter','Integration','FailureState','ValidatorMutations','FileFixtureIntake','FilePartitions','ObjectObservationPartitions','ObjectMergeProjection','ConfigurationPartitions','CanonicalPartitions','DispatchPartitions','InputAccounting','OutputSerialization','PublicationTransaction','PublicationIntegration')]
    [string]$Case = 'Pure'
)
...
if($Case -ceq 'OutputSerialization'){
    ...
    if($passed.discoveryArtifactFingerprint-cne'046312af6d04e6ce97ed8e3c9f88a27228ed1fe9ffeacb26774b415863463b1b'-or$passed.diagnosticBundleFingerprint-cne'2c810f53d005d7afb561d5691f3e097d4fe8b11242175067774275f4a1c61c03'){throw "Passed HI-13c/HI-14 literal mismatch: $($passed.discoveryArtifactFingerprint),$($passed.diagnosticBundleFingerprint)"}
    if(($passed.artifacts.sha256-join',')-cne'e2f3cb01cd005a7f046d4cdd61a6df873d3406e0d40f0695792d71d04f9f0441,f7a1df2e1123315aa2d028e6c834378c35bacaa54940995eed44581f299a1f41,a2158b021996031dcb5569fb7c19715c545c5ae1eceb92eed41f9b6cad65c576,3af8afe7ad4a2644ec84356b713a523e733be076f6d3b68067c34cb2f1c67e23,3adc6b778cda62077307756185799fd64e9bab5bee1484afae43ef2c514c7087,29fdc5f42906ab14a7a3af2c836f4667c56bb5c425e904665c087c33bee80f93,a54aac3f13e0058ac63826a48535859e59d7e7cccac9d32d9e8bff85b721a03f,ef747cfeb65e616496e7dd16d70ae5b260a466e0e19cfb9113e8226dae03173c'){throw "Passed CT-15 literal SHA set mismatch: $($passed.artifacts.sha256-join',')"}
