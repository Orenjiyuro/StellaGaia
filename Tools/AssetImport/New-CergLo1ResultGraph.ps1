...
function Assert-CergUpstreamBindings {
    ...
    if($isR2Attempt){
        ...
        if($Readiness.schemaVersion-cne'cerg-r2-aplus-readiness/1.2.0'-or$Readiness.artifactId-cne'R2-TO05'-or$Readiness.status-cne'Green'){throw'R2 readiness identity is invalid.'}
