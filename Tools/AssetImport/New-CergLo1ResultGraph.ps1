...
function Assert-CergUpstreamBindings {
    ...
    if($isR2Attempt){
        ...
        if($Readiness.schemaVersion-cne'cerg-r2-aplus-readiness/1.3.0'-or$Readiness.artifactId-cne'R2-TO06'-or$Readiness.status-cne'Green'){throw'R2 readiness identity is invalid.'}
