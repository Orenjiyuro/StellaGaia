...
function New-C2PublicationTestSerialization {
    ...
    $generatedAt=$GeneratedAt;$snapshotId='snapshot-pc-install-001';$inputFingerprint='aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa';$discoveryInputFingerprint=if($GateStatus-ceq'Passed'){'f2360d25078bfd90ca88a85ea1e801cb583841d3ef4cfbad0c8c92d2d0ba3eab'}else{$null}
