...
try{
    ...
    $readiness=[pscustomobject][ordered]@{schemaVersion='cerg-r2-aplus-readiness/1.4.0';artifactId='R2-TO07';contractHeadCommit=$head;toolRows=$readyRows;status='Green'}
